    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/reset_password_user">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password_a" type="password" class="form-control{{ $errors->has('password_a') ? ' is-invalid' : '' }}" name="password_a" required>

                                @if ($errors->has('password_a'))
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('password_a') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
