...
@section('content')
    ...
    <ul>
        ...
        @foreach($courses as $course)
            ...
            <li><a href="{{route('courses.show', $course->crs_id)}}">{{$course->crs_name}}</a></li>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="pay_id" class="form-control">
                                    ...
                                    <option value=<?php $dados["pay_id"]?>>R$ <?php echo $dados ["pay_value"];?>,00</option>
                                    <?php }?>
                                </select>
                            </div>
                            ...
                            {
                                $pay_id= $_POST['pay_id'];
                                $sql= $conn->prepare("Insert into payments(pay_id) values (:pay_id);");
