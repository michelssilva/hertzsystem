    ...
    <ul>
        <li>
            ...
            <div class="content">
                ...
                $query = "SELECT * FROM reservas_centro where dds_id=1 ";
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
                ...
                <table id="tb_segunda">
                    ...
                    <tr>
                        <td title="rsc_id" ><?php echo $dado["rsc_id"]?></td>
                        <td title="rsc_horario" ><?php echo $dado["rsc_horario"]?></td>
                        <td title="rsc_professor" class="editavel"><?php echo $dado["rsc_professor"]?></td>
                        <td title="rsc_instrumento" class="editavel"><?php echo $dado["rsc_instrumento"]?></td>
                        <td title="rsc_tipo_reserva" class="editavel"><?php echo $dado["rsc_tipo_reserva"]?></td>
                        <td title="rsc_aluno" class="editavel"><?php echo $dado["rsc_aluno"]?></td>
                        <td title="rsc_sala" class="editavel"><?php echo $dado["rsc_sala"]?></td>
                        <td title="rsc_mensalidade" class="editavel"><?php echo $dado["rsc_mensalidade"]?></td>
                    </tr>
                    <?php }?>
                </table>
        ...
        <li>
            ...
            <div class="content">
                ...
                $conn = new mysqli($servername, $username, $password, $dbname);
                $query = "SELECT * FROM reservas_centro where dds_id=2 ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
                ...
                <table id="tb_segunda">
                    ...
                    <tr>
                        <td title="rsc_id" ><?php echo $dado["rsc_id"]?></td>
                        <td title="rsc_horario" class="editavel"><?php echo $dado["rsc_horario"]?></td>
                        <td title="rsc_professor" class="editavel"><?php echo $dado["rsc_professor"]?></td>
                        <td title="rsc_instrumento" class="editavel"><?php echo $dado["rsc_instrumento"]?></td>
                        <td title="rsc_tipo_reserva" class="editavel"><?php echo $dado["rsc_tipo_reserva"]?></td>
                        <td title="rsc_aluno" class="editavel"><?php echo $dado["rsc_aluno"]?></td>
        ...
        <li>
            ...
            <div class="content">
                ...
                $query = "SELECT * FROM reservas_centro where dds_id=3 ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
        ...
        <li>
            ...
            <div class="content">
                ...
                $query = "SELECT * FROM reservas_centro where dds_id=4 ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
        ...
        <li>
            ...
            <div class="content">
                ...
                $query = "SELECT * FROM reservas_centro where dds_id=5 ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
        ...
        <li>
            ...
            <div class="content">
                <?php
                $conn = new mysqli($servername, $username, $password, $dbname);
                $query = "SELECT * FROM reservas_centro where dds_id=6 ";
            ...
            $(this).html(novoElemento.bind('blur keydown', function(e){
                ...
                if(keyCode == 13) {
                    ...
                    if (conteudoNovo != "") {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "alterar_reservas_centro.php",
                            data: {
