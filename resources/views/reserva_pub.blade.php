    ...
    <ul>
        <li>
            ...
            <div class="content">
                ...
                $query = "SELECT * FROM reservas_pub where dds_id=1 ";
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
                ...
                <table id="tb_segunda">
                    ...
                    <tr>
                        <td title="rsp_id" ><?php echo $dado["rsp_id"]?></td>
                        <td title="rsp_horario" class="editavel"><?php echo $dado["rsp_horario"]?></td>
                        <td title="rsp_professor" class="editavel"><?php echo $dado["rsp_professor"]?></td>
                        <td title="rsp_instrumento" class="editavel"><?php echo $dado["rsp_instrumento"]?></td>
                        <td title="rsp_tipo_reserva" class="editavel"><?php echo $dado["rsp_tipo_reserva"]?></td>
                        <td title="rsp_aluno" class="editavel"><?php echo $dado["rsp_aluno"]?></td>
                        <td title="rsp_sala" class="editavel"><?php echo $dado["rsp_sala"]?></td>
                        <td title="rsp_mensalidade" class="editavel"><?php echo $dado["rsp_mensalidade"]?></td>
                    </tr>
                    <?php }?>
                </table>
        ...
        <li>
            ...
            <div class="content">
                ...
                $conn = new mysqli($servername, $username, $password, $dbname);
                $query = "SELECT * FROM reservas_pub where dds_id=2 ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
        ...
        <li>
            ...
            <div class="content">
                ...
                $query = "SELECT * FROM reservas_pub where dds_id=3 ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
        ...
        <li>
            ...
            <div class="content">
                ...
                $query = "SELECT * FROM reservas_pub where dds_id=4 ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
        ...
        <li>
            ...
            <div class="content">
                ...
                $query = "SELECT * FROM reservas_pub where dds_id=5 ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
        ...
        <li>
            ...
            <div class="content">
                ...
                $query = "SELECT * FROM reservas_pub where dds_id=6 ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
