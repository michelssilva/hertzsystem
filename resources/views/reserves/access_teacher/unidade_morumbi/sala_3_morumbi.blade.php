    ...
    <ul>
        <li>
            ...
            <div class="content">
                ...
                $query = "select * from reserves where rsv_unit='morumbi' and rsv_class='sala 3' and rsv_week_day='segunda-feira'; ";
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
        ...
        <li>
            ...
            <div class="content">
                ...
                $conn = new mysqli($servername, $username, $password, $dbname);
                $query = "select * from reserves where rsv_unit='morumbi' and rsv_class='sala 3' and rsv_week_day='terca-feira'; ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
        ...
        <li>
            ...
            <div class="content">
                ...
                $query = "select * from reserves where rsv_unit='morumbi' and rsv_class='sala 3' and rsv_week_day='quarta-feira'; ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
        ...
        <li>
            ...
            <div class="content">
                ...
                $query = "select * from reserves where rsv_unit='morumbi' and rsv_class='sala 3' and rsv_week_day='quinta-feira'; ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
        ...
        <li>
            ...
            <div class="content">
                ...
                $query = "select * from reserves where rsv_unit='morumbi' and rsv_class='sala 3' and rsv_week_day='sexta-feira'; ";
                $con=$conn->query($query); // Armazenei separadamente o comando SQL em uma variavel;
...
//    echo "\n\nExecução SQL com sucesso!";    JÁ TESTEI E SEI ESTÁ RODANDO COMANDO SQL COM SUCESSO.
        ...
        <li>
            ...
            <div class="content">
                <?php
                $conn = new mysqli($servername, $username, $password, $dbname);
                $query = "select * from reserves where rsv_unit='morumbi' and rsv_class='sala 3' and rsv_week_day='sabado'; ";
