...
<head>
    <title>{{$unt_name}} SALA{{$number_class}}</title>
    <style>
        *{
            margin: 0;
            padding: 0;
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <table id='minhaTabela'>
                                                ...
                                                <?php while($dados=$con1->fetch_array() ){?>
                                                <tr>
                                                    <td style="font-family: Arial; background-color: #a6e1ec">{{explode(' ', $dados["usr_name"])[0]}}</td>
                                                    <td style="font-family: Arial"><?php echo $dados ["usr_code_user"];?></td>
                ...
                <table id="tb_sabado">
                    ...
                    <tr>
                        ...
                        <td style="background: #5cd08d; color: #0b2e13; text-align: center " ><strong> <?php
                                ...
                                $query = "select sum(rsv_payment) as total from reserves r inner join units u where unt_name='$unt_name' and rsv_class=$number_class and rsv_week_day='sabado-feira' and u.unt_id=r.unt_id;";
                                $con1=$conn->query($query);
                ...
                <table id="tb_domingo">
                    ...
                    <tr>
                        ...
                        <td style="background: #5cd08d; color: #0b2e13; text-align: center " ><strong> <?php
                                ...
                                $query = "select sum(rsv_payment) as total from reserves r inner join units u where unt_name='$unt_name' and rsv_class=$number_class and rsv_week_day='domingo-feira' and u.unt_id=r.unt_id;";
                                $con1=$conn->query($query);
