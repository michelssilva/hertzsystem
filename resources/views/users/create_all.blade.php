                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        {!! Form::open(['method'=>'POST', 'action'=>'UsersController@store']) !!}
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Função') }}</label>
                            ...
                            if(isset($_POST['submit']))
                            {
                                ...
                                $sql= $conn->prepare("Insert into users(usr_role) values (:usr_role);");
                                $conn->begin_transaction();
                                $sql->execute(array(':usr_role'=>$usr_role));
                                $conn->commit();
