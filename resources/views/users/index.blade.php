...
<div class="container">
    ...
    <div id="dvTabela" class="table-responsive">
        ...
        <table id='minhaTabela'>
            ...
            <tbody id="tbody"><?php while($dados=$con1->fetch_array() ){?><tr><td><?php echo $dados ["usr_name"];?><br><a href="{{route('users.show', $dados["usr_id"])}}"> Editar</a></td><td> <?php echo $dados ["usr_code_user"];?> </td><td> <?php echo $dados ["usr_role"];?> </td><td> <?php echo $dados ["usr_email"];?> </td><td> <?php echo $dados ["usr_cpf"];?></td><td> <?php echo $dados ["usr_cell_phone"];?></td><td> <?php echo $dados ["usr_telephone"];?></td><td> <?php echo $dados ["usr_state"];?></td><td> <?php echo $dados ["usr_city"];?></td><td> <?php echo $dados ["usr_address"];?></td><td> <?php echo $dados ["usr_number"];?></td><td> <?php echo $dados ["usr_neighborhood"];?></td><td> <?php echo $dados ["usr_zip_code"];?></td></tr><?php }?></tbody>
